...
var glossary={
  ...
  'ARIA':{tag:'Valuta AIROOBI',def:'ARIA è la moneta di test di AIROOBI. La ricevi gratis ogni giorno dal faucet, check-in e referral. Più ARIA muovi, più partecipi. Tutti gli ARIA accumulati in Alpha conteranno per l\'airdrop finale al lancio della mainnet.'},
  'Airdrop':{tag:'Meccanismo core',def:'Un airdrop su AIROOBI è la distribuzione di un oggetto reale di valore (da €500 in su) alla community. Chi partecipa muove ARIA di test e accumula ROBI che crescono di valore nel tempo.'},
  ...
  'Fase Alpha':{tag:'Roadmap · Community',def:'La Fase Alpha è la prima fase di AIROOBI — quella in cui sei adesso. È live. Ogni azione che fai muove ARIA di test. Più ne muovi, più conti per l\'airdrop finale. Chi partecipa in Alpha ottiene vantaggi permanenti su tutte le fasi successive.'},
  'Referral':{tag:'Community · Bonus',def:'Il referral è il meccanismo con cui porti nuovi utenti su AIROOBI usando il tuo codice personale. Quando un amico si registra con il tuo codice e fa il primo login, tu ricevi +10 ARIA di test e lui +15. Nessun limite al numero di referral — più amici porti, più ARIA muovi.'}
};
...
{slug:'come-guadagnare-punti-aria-airoobi',title:'Come ricevere ARIA di test su AIROOBI: la guida completa',date:'14 Marzo 2026',meta:'Guida completa per ricevere ARIA di test su AIROOBI: faucet, check-in, video, referral e strategia.',body:'<p>ARIA è la moneta di test di AIROOBI. Riceverla è semplice, ma muoverla in modo strategico può fare la differenza. Più ARIA muovi, più partecipi. Quello che si guadagna davvero sono i ROBI.</p><h2>Cos\'è ARIA</h2><p>ARIA è la moneta di test di AIROOBI. Non si compra — si riceve gratis attraverso attività sulla piattaforma. Ogni movimento di ARIA conta come partecipazione. Tutti gli ARIA accumulati in Alpha conteranno per l\'airdrop finale al lancio della mainnet.</p><h2>Come ricevere ARIA di test</h2><h3>Faucet giornaliero</h3><p>Ogni giorno puoi ricevere 100 ARIA di test dal faucet. È il modo principale per muovere ARIA sulla piattaforma.</p><h3>Check-in giornaliero</h3><p>Ogni giorno che accedi alla piattaforma e completi il check-in ricevi +1 ARIA. La costanza è premiata: chi entra ogni giorno muove più ARIA di chi partecipa in modo irregolare.</p><h3>Visualizzazione video</h3><p>Guardare i contenuti informativi sulla piattaforma vale +1 ARIA per video, fino a un massimo di 5 video al giorno.</p><h3>Streak settimanale</h3><p>Chi completa il check-in per sette giorni consecutivi riceve +1 ARIA bonus.</p><h3>Programma referral</h3><p>Invitare un amico che si registra e fa il primo login: tu ricevi +10 ARIA, il tuo amico +15 ARIA. Il referral è uno degli strumenti più potenti per chi vuole muovere ARIA rapidamente.</p><h2>ARIA e ROBI: due livelli diversi</h2><p>ARIA sono monete di test per la partecipazione. Quello che si guadagna davvero — con valore reale — sono i ROBI: NFT che crescono di valore nel tempo e sono riscuotibili in KAS.</p><h2>ARIA nella fase Alpha Brave</h2><p>Durante la fase Alpha Brave — riservata ai primi mille utenti — tutti gli ARIA di test che muovi contano per l\'airdrop finale al lancio della mainnet. Chi muove più ARIA oggi avrà un vantaggio strutturale sugli utenti che arriveranno dopo.</p>'},
...
function openBlogArticle(hashSlug){
  ...
  html+='</article>';
  // CTA
  html+='<div class="blog-cta"><div class="blog-cta-title"><span class="it">Scopri <em>AIROOBI</em></span><span class="en">Discover <em>AIROOBI</em></span></div><p class="blog-cta-sub"><span class="it">Registrati gratis. Ricevi ARIA di test e inizia a partecipare agli airdrop.</span><span class="en">Sign up for free. Get test ARIA and start participating in airdrops.</span></p><a href="#signup" class="blog-cta-btn"><span class="it">Registrati</span><span class="en">Sign Up</span></a></div>';
  c.innerHTML=html;
  document.getElementById('blog-overlay').classList.add('active');
...
function closeBlog(){
  ...
  var metaDesc=document.querySelector('meta[name="description"]');
  if(metaDesc)metaDesc.setAttribute('content','AIROOBI è il marketplace dove realizzi i tuoi desideri. Oggetti reali di valore, a un prezzo che non crederesti. ARIA di test gratis ogni giorno — più ne muovi, più partecipi.');
...
var RD_PHASES={
  alpha:{
    ...
    desc_it:'La prima fase di AIROOBI. Sei tra i primi 1.000 utenti a testare la piattaforma. Ogni azione muove ARIA di test. Più ne muovi, più conti per l\'airdrop finale. Chi partecipa in Alpha ottiene vantaggi permanenti su tutte le fasi successive.',
    desc_en:'The first phase of AIROOBI. You are among the first 1,000 users to test the platform. Every action moves test ARIA. The more you move, the more you count for the final airdrop. Alpha participants get permanent advantages in all subsequent phases.',
    features_it:['Ricevi ARIA di test da faucet, check-in e referral','Badge Fondatore NFT gratuito per i primi 1.000','Accesso prioritario ai primi airdrop','Moltiplicatori ARIA più alti di qualsiasi tier futuro','Partecipazione alla governance community'],
    features_en:['Get test ARIA from faucet, check-ins and referrals','Free Founder NFT Badge for the first 1,000','Priority access to first airdrops','Highest ARIA multipliers of any future tier','Community governance participation'],
    showStats:true
  },
  beta:{
