...
var glossary={
  ...
  'ARIA':{tag:'Valuta AIROOBI',def:'ARIA è la valuta di AIROOBI, attualmente in fase testnet. La ricevi gratis ogni giorno dal faucet, check-in e referral. Al lancio della mainnet varrà €0,10 ciascuno. Più ARIA accumuli, più partecipi — e più ROBI guadagni.'},
...
{slug:'come-guadagnare-punti-aria-airoobi',title:'Come accumulare ARIA su AIROOBI: la guida completa',date:'14 Marzo 2026',meta:'Guida completa per accumulare ARIA su AIROOBI (testnet): faucet, check-in, video, referral e strategia.',body:'<p>ARIA è la valuta di AIROOBI, attualmente in fase testnet. Accumularla è semplice, ma farlo in modo strategico fa la differenza. Siamo in testnet: al lancio della mainnet ogni ARIA varrà €0,10. Il vero reward però sono i ROBI — e più ARIA accumuli, più ne guadagni.</p><h2>Cos\'è ARIA</h2><p>ARIA è la valuta di AIROOBI. Non si compra — si accumula gratis attraverso attività sulla piattaforma. Siamo in fase testnet: ogni ARIA accumulato ora conterà per l\'airdrop finale al lancio della mainnet, con un valore di €0,10 ciascuno.</p><h2>Come accumulare ARIA</h2><h3>Faucet giornaliero</h3><p>Ogni giorno puoi ricevere 100 ARIA dal faucet. È il modo principale per accumulare ARIA sulla piattaforma — approfitta ora: il faucet diminuirà progressivamente nel tempo.</p><h3>Check-in giornaliero</h3><p>Ogni giorno che accedi alla piattaforma e completi il check-in ricevi +1 ARIA. La costanza è premiata: chi entra ogni giorno accumula più ARIA di chi partecipa in modo irregolare.</p><h3>Visualizzazione video</h3><p>Guardare i contenuti informativi sulla piattaforma vale +1 ARIA per video, fino a un massimo di 5 video al giorno.</p><h3>Streak settimanale</h3><p>Chi completa il check-in per sette giorni consecutivi riceve +1 ARIA bonus.</p><h3>Programma referral</h3><p>Invitare un amico che si registra e fa il primo login: tu ricevi +10 ARIA, il tuo amico +15 ARIA. Il referral è uno degli strumenti più potenti per chi vuole accumulare ARIA rapidamente.</p><h2>ARIA e ROBI: due livelli diversi</h2><p>Accumuli ARIA per partecipare agli airdrop. Quello che guadagni davvero — il vero reward di AIROOBI — sono i ROBI: NFT che crescono di valore nel tempo e sono riscuotibili in KAS. Più partecipi, più ROBI ottieni.</p><h2>ARIA nella fase Alpha Brave</h2><p>Durante la fase Alpha Brave — riservata ai primi mille utenti — ogni ARIA che accumuli conta per l\'airdrop finale al lancio della mainnet. Chi accumula più ARIA oggi avrà un vantaggio strutturale sugli utenti che arriveranno dopo.</p>'},
...
function closeBlog(){
  ...
  var metaDesc=document.querySelector('meta[name="description"]');
  if(metaDesc)metaDesc.setAttribute('content','AIROOBI è il marketplace dove realizzi i tuoi desideri. Oggetti reali di valore, a un prezzo che non crederesti. Accumula ARIA (testnet, varrà €0,10) ogni giorno — più partecipi, più ROBI guadagni.');
...
var RD_PHASES={
  alpha:{
    ...
    desc_it:'La prima fase di AIROOBI. Sei tra i primi 1.000 utenti sulla piattaforma. Siamo in fase testnet: ogni azione accumula ARIA (che varrà €0,10 a mainnet). Più ARIA accumuli, più ROBI guadagni. Chi partecipa in Alpha ottiene vantaggi permanenti su tutte le fasi successive.',
    desc_en:'The first phase of AIROOBI. You are among the first 1,000 users on the platform. We are in testnet phase: every action accumulates ARIA (worth €0.10 at mainnet). The more ARIA you accumulate, the more ROBI you earn. Alpha participants get permanent advantages in all subsequent phases.',
    features_it:['Accumula ARIA (testnet) da faucet, check-in e referral','Badge Fondatore NFT gratuito per i primi 1.000','Accesso prioritario ai primi airdrop','Moltiplicatori ARIA più alti di qualsiasi tier futuro','Partecipazione alla governance community'],
    features_en:['Accumulate ARIA (testnet) from faucet, check-ins and referrals','Free Founder NFT Badge for the first 1,000','Priority access to first airdrops','Highest ARIA multipliers of any future tier','Community governance participation'],
    showStats:true
  },
  beta:{
