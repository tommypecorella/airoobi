...
var glossary={
  ...
  'Token':{tag:'Tecnologia · Crypto',def:'Un token è un\'unità digitale registrata su blockchain che rappresenta un diritto, un valore o un\'utilità. Su AIROOBI ci sono due tipi: ARIA (la valuta della piattaforma) e ROBI (NFT che rappresentano quote del Fondo Comune con saldo garantito).'},
...
var RD_PHASES={
  ...
  mainnet:{
    ...
    features_it:['Smart contract KRC-20 on-chain','Primo airdrop con oggetto fisico reale','ROBI convertibili in KAS','Fondo Comune trasparente e verificabile','Marketplace aperto a venditori P2P e business'],
