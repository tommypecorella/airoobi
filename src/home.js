...
var glossary={
  ...
  'ARIA':{tag:'Valuta AIROOBI',def:'ARIA è la valuta di AIROOBI, attualmente in fase testnet. La ricevi gratis ogni giorno dal faucet, dagli ingressi e dai referral. Più partecipi, più ROBI raccogli lungo la corsa.'},
  'Airdrop':{tag:'Meccanismo core',def:'Un airdrop su AIROOBI è la distribuzione di un oggetto reale di valore (da €500 in su) alla community. Chi partecipa muove ARIA e accumula ROBI che crescono di valore nel tempo.'},
  ...
  'Alpha Brave':{tag:'Fase · Community',def:'Gli Alpha Brave sono i primi 1.000 utenti di AIROOBI. Ottengono vantaggi permanenti su tutti gli airdrop futuri, Badge Fondatore + ROBI di benvenuto e un moltiplicatore sugli ARIA. È un riconoscimento per chi crede nel progetto prima che diventi ovvio.'},
  ...
  'Fase Alpha':{tag:'Roadmap · Community',def:'La Fase Alpha è la prima fase di AIROOBI — quella in cui sei adesso. È live, siamo in fase testnet. Ogni azione che fai accumula ARIA. Più ne accumuli, più ROBI guadagni. Chi partecipa in Alpha ottiene vantaggi permanenti su tutte le fasi successive.'},
  'Referral':{tag:'Community · Bonus',def:'Il referral è il meccanismo con cui porti nuovi utenti su AIROOBI usando il tuo codice personale. Quando un amico si registra con il tuo codice e fa il primo login, tu ricevi +10 ARIA e lui +15. Nessun limite al numero di referral — più amici porti, più ARIA accumuli e più ROBI guadagni.'}
};
...
function openBlogArticle(hashSlug){
  ...
  html+='</article>';
  // CTA
  html+='<div class="blog-cta"><div class="blog-cta-title"><span class="it">Scopri <em>AIROOBI</em></span><span class="en">Discover <em>AIROOBI</em></span></div><p class="blog-cta-sub"><span class="it">Registrati gratis. Accumula ARIA (testnet) e inizia a partecipare agli airdrop — più partecipi, più ROBI guadagni.</span><span class="en">Sign up for free. Accumulate ARIA (testnet) and start participating in airdrops — the more you join, the more ROBI you earn.</span></p><a href="#signup" class="blog-cta-btn"><span class="it">Registrati</span><span class="en">Sign Up</span></a></div>';
  c.innerHTML=html;
  document.getElementById('blog-overlay').classList.add('active');
...
function closeBlog(){
  ...
  var metaDesc=document.querySelector('meta[name="description"]');
  if(metaDesc)metaDesc.setAttribute('content','AIROOBI è il marketplace dove realizzi i tuoi desideri. Oggetti reali di valore, a un prezzo che non crederesti. Accumula ARIA ogni giorno — più partecipi, più ROBI guadagni.');
...
var RD_PHASES={
  alpha:{
    ...
    desc_it:'La prima fase di AIROOBI. Sei tra i primi 1.000 utenti sulla piattaforma. Siamo in fase testnet: ogni azione accumula ARIA. Più ARIA accumuli, più ROBI guadagni. Chi partecipa in Alpha ottiene vantaggi permanenti su tutte le fasi successive.',
    desc_en:'The first phase of AIROOBI. You are among the first 1,000 users on the platform. We are in testnet phase: every action accumulates ARIA. The more ARIA you accumulate, the more ROBI you earn. Alpha participants get permanent advantages in all subsequent phases.',
    features_it:['Accumula ARIA (testnet) da faucet, ingressi e referral','Badge Fondatore NFT gratuito per i primi 1.000','Accesso prioritario ai primi airdrop','Moltiplicatori ARIA più alti di qualsiasi tier futuro','Partecipazione alla governance community'],
    features_en:['Accumulate ARIA (testnet) from faucet, daily entries and referrals','Free Founder NFT Badge for the first 1,000','Priority access to first airdrops','Highest ARIA multipliers of any future tier','Community governance participation'],
    showStats:true
  },
  beta:{
