...
+'html[data-theme="dark"] .app-share a,html[data-theme="dark"] .app-share button{border-color:#3A434F;color:#AEB9C6}'+'.app-share a:hover,.app-share button:hover{border-color:var(--gold,#EF3E4F);color:var(--gold,#EF3E4F)}';
