---
deliverable_id: LEG-002
title: AIROOBI Treasury Backing Methodology v1
version: 1.0
status: PUBLISHED
date_signoff: 2026-05-01
signed_off_by: Tommaso Pecorella (Skeezu · founder/CEO) via SSH RS treasury_methodology_signoff_approved
authored_by: CCP (Claude Code · CIO/CTO Airoobi)
reviewed_by: ROBY (Strategic MKT, Comms & Community Manager · 8 fix recepiti integralmente)
canonical_path: 01_deliverables_docs/business/AIROOBI_Treasury_Methodology_v1.md
related_deliverables: LEG-001 (Legal Framework, cross-link in v2.1), BUS-002 (Tokenomics)
source_draft: CLA-CCP BRIDGE/ROBY-Stuff/for-CCP/CCP_Treasury_Backing_Methodology_v1_FINAL.md
---

> **🔏 Sign-off**: documento firmato da Skeezu il 2026-05-01 e promosso a `LEG-002` ufficiale. Versione canonica del repo. Per modifiche future bumpare a v1.1 (typo/rephrase) o v2.0 (decisione "1-to-1 mint vs IOU" — vedi §10).
